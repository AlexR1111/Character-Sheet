...
function Aligment() {
    const [selectedAligment, setSelectedAligment]= useState("");
    const [aligmentDescription, setAligmentDescription] = useState("");

    const aligmentDescriptions = {
    ...
    const handleAligmentChange =(event) => {
        const chosenAligment = event.target.value;
        setSelectedAligment(chosenAligment);
        setAligmentDescription(aligmentDescriptions[chosenAligment]);
    };
    ...
    return (
        <div>
            ...
            <br/>
            <select id='aligment' className='aligment' onChange={handleAligmentChange}>
